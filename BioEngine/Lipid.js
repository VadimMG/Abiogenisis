...
class Lipid extends Entity {
    ...
    tick(entities) {//force apart head-tail
        ...
        for (var i = 0, n = entities.length; i < n; i++) {
            ...
            if (e != this && e.ent_id == Calc.LIPID_ID) {
                ...
                if (ydist2 != 0 && xdist2 != 0 && dist2 >= this.radius  && !this.struc[0].isCollide && !e.struc[0].isCollide)  {// && !this.struc[0].isCollide && !e.struc[0].isCollide
    ...
    forceHead(angle, mag) {
        ...
        var xang = Math.cos(this.o_angle.getValue() * Calc.DEGTORAD) * .5;
        var yang = Math.sin(this.o_angle.getValue() * Calc.DEGTORAD) * .5;
